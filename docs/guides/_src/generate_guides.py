...
RO = {
    ...
    "features": [
        ...
        ("Checklist-uri și șabloane", "Checklist-uri per proiect (pre-filmare, post-filmare, sau personalizate), cu item-uri bifabile și bară de progres. Șabloanele reutilizabile se gestionează din Setări."),
...
EN = {
    ...
    "features": [
        ...
        ("Checklists & templates", "Per-project checklists (pre-shoot, post-shoot, or custom), with checkable items and a progress bar. Reusable templates are managed from Settings."),
...
ES = {
    ...
    "features": [
        ...
        ("Checklists y plantillas", "Checklists por proyecto (pre-rodaje, post-rodaje, o personalizados), con ítems marcables y barra de progreso. Las plantillas reutilizables se gestionan desde Ajustes."),
