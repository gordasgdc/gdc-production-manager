...
RO = {
    ...
    "what_license_note": "Codul sursă e deschis (licență MIT), disponibil integral pe GitHub. Aplicația compilată, distribuită ca instalator, are 25 de zile de probă gratuită, apoi necesită activare — vezi secțiunea 7 pentru detalii.",
    ...
    "faq": [
        ...
        ("Vreau să pornesc de la zero (șterg toate datele vechi înainte de o instalare nouă)", [
            "O instalare nouă PESTE una veche păstrează datele (conturi, proiecte, clienți) — așa e gândit, ca actualizările să nu șteargă nimic. Dacă vrei totuși un start complet curat:",
            "Închide aplicația complet.",
            "Mac: șterge folderul ~/Library/Application Support/GDCProductionManager (din Finder: ⌘+Shift+G, lipește calea, Enter, apoi șterge folderul).",
            "Windows: șterge folderul %APPDATA%\\GDCProductionManager (din Explorer: lipește \"%APPDATA%\" în bara de adresă, Enter, apoi șterge folderul GDCProductionManager).",
            "La următoarea pornire, aplicația pornește complet curată, ca la prima instalare — fără cont, fără proiecte.",
        ]),
    ],
    "sec7_title": "Licență și activare",
    "license_p1": "GDC Production Manager are 25 de zile de probă completă, fără nicio limitare — poți testa absolut tot. După aceea, aplicația necesită o activare pe viață: 25€, o singură dată, fără abonament, fără reînnoiri.",
...
EN = {
    ...
    "what_license_note": "The source code is open (MIT license), fully available on GitHub. The compiled, distributed app has a 25-day free trial, then requires activation — see section 7 for details.",
    ...
    "faq": [
        ...
        ("I want a completely fresh start (delete all old data before a new install)", [
            "Installing a new version OVER an old one keeps your data (accounts, projects, clients) on purpose — updates shouldn't erase anything. If you still want a truly clean start:",
            "Quit the app completely.",
            "Mac: delete the folder ~/Library/Application Support/GDCProductionManager (in Finder: ⌘+Shift+G, paste the path, Enter, then delete the folder).",
            "Windows: delete the folder %APPDATA%\\GDCProductionManager (in Explorer: paste \"%APPDATA%\" into the address bar, Enter, then delete the GDCProductionManager folder).",
            "The next launch starts completely clean, like a first install — no account, no projects.",
        ]),
    ],
    "sec7_title": "License & activation",
    "license_p1": "GDC Production Manager has a 25-day full trial, with no limitations — you can test absolutely everything. After that, the app requires a lifetime activation: 25€, one time, no subscription, no renewals.",
...
ES = {
    ...
    "what_license_note": "El código fuente es abierto (licencia MIT), disponible por completo en GitHub. La app compilada y distribuida tiene 25 días de prueba gratuita, luego requiere activación — ver la sección 7 para más detalles.",
    ...
    "faq": [
        ...
        ("Quiero empezar completamente de cero (borrar todos los datos antiguos antes de una instalación nueva)", [
            "Instalar una versión nueva ENCIMA de una antigua conserva tus datos (cuentas, proyectos, clientes) a propósito — una actualización no debería borrar nada. Si aun así quieres un inicio totalmente limpio:",
            "Cierra la aplicación por completo.",
            "Mac: borra la carpeta ~/Library/Application Support/GDCProductionManager (en Finder: ⌘+Shift+G, pega la ruta, Enter, luego borra la carpeta).",
            "Windows: borra la carpeta %APPDATA%\\GDCProductionManager (en el Explorador: pega \"%APPDATA%\" en la barra de direcciones, Enter, luego borra la carpeta GDCProductionManager).",
            "Al siguiente inicio, la app arranca completamente limpia, como en la primera instalación — sin cuenta, sin proyectos.",
        ]),
    ],
    "sec7_title": "Licencia y activación",
    "license_p1": "GDC Production Manager tiene 25 días de prueba completa, sin ninguna limitación — puedes probar absolutamente todo. Después, la app requiere una activación de por vida: 25€, pago único, sin suscripción, sin renovaciones.",
