...
APP_VERSION = "2.0.1"  # actualizeaza aici la fiecare "git tag vX.Y.Z" - vezi si docs/update.json
APP_VERSION_URL = "https://gordas.dev/gdc-production-manager/update.json"
